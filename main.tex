...
\begin{itemize}
	...
	\item \textit{\textbf{Assumption 2:}}The space elevator's clean energy utilization rate is 0.3, and it will steadily increase with technological advancements until it reaches 100%.
	\\$\hookrightarrow$ \textit{\textbf{Explanation:}}Based on green science principles and reasonable scenario settings.
	\item \textit{\textbf{Assumption 3:}}Imperfect state parameters: TR transmission failure probability of 1%, which will decrease to 0.1% with technological advancement.
	...
	\item \textit{\textbf{Assumption 4:}}The cost of an apex rocket launch failure is not counted.
