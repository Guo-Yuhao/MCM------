...
\begin{equation}
	\kappa_{TR}=10 \cdot f_{TR}(j) \cdot m_{load}=10 \times 20 \times 125=25,000 \text{ tons/year}
\end{equation}
...
The total duration required to transport all materials is:
\begin{equation}
	T_{TR}=\frac{M_{tot}}{\kappa_{TR}}=\frac{1 \times 10^8}{25000}=4000 \text{ years}
\end{equation}
...
\begin{itemize}
	...
	Adopting the optimal allocation ratio, the duration is approximately $\max\left(\frac{0.417 \times 10^8}{179000}, \frac{0.583 \times 10^8}{25000}\right) \approx 232$ years, 
...
\begin{table}[hbtp]
  ...
  \label{tab:results}
   \begin{tabular}{lcccc}
    ...
    Durations(year) & & & & \\
    Cost(BD) & & & & \\
	\makecell{Cost of maintaining water supply (BD)} & & & & \\
